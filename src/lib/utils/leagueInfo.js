...
export const managers = [
    / {
    /   "roster": 605958050657935360,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
    /   "name": "Alex",
    /   "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
    /   "location": "St. Pete", // (optional)
    /   "bio": "Lorem ipsum...",
    /   "photo": "IMG_1007.jpeg", // square ratio recommended (no larger than 500x500)
